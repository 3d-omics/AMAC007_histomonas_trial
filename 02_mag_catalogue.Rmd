...
# Add text
circular_tree <-  circular_tree +
        annotate('text', x=3.4, y=0.2, label='            Phylum', family='arial', size=3.5) +
        annotate('text', x=4.1, y=0.2, label='                         Genome quality', family='arial', size=3.5) +
        annotate('text', x=4.7, y=0.2, label='                     Genome size', family='arial', size=3.5)
...
```
## Taxonomic overview
```{r taxonomy_stats, message=FALSE, warning=FALSE, fig.height=10}

genome_metadata %>% 
  filter(species != "s__") %>% nrow()
